...
var $author$project$Generate$initOutfit = {feet_1: '', feet_2: '', head: '', legs: '', torso_1: '', torso_2: '', torso_3: ''};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Generate$init = function (currentDate) {
	return _Utils_Tuple2(
		{city: '', currentDate: currentDate, fashion: 0, outfit: $author$project$Generate$initOutfit, temperature: 0},
...
var $author$project$Generate$Outfit = F7(
...
var $author$project$Generate$outfitDecoder = A2(
	...
	A8(
		...
		$author$project$Generate$Outfit,
...
var $author$project$Generate$outfitToString = function (outfit) {
	return outfit.head + (' - ' + (outfit.torso_1 + (' - ' + (outfit.torso_2 + (' - ' + (outfit.torso_3 + (' - ' + (outfit.legs + (' - ' + (outfit.feet_1 + (' - ' + outfit.feet_2)))))))))));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Generate$ChangeCity)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Generate$ChangeFashion)
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Generate$outfitToString(model.outfit))
					]))
			]));
};
